...
const Workouts = () => {
    ...
    const submit = async (e) => {
        ...
        if (edit) {
            ...
            let updateData = await axios.put("http://localhost:3005/api/workouts/" + workout._id, workoutl, {
                headers: {
            ...
            let saveData = await axios.post("http://localhost:3005/api/workouts/", workoutl, {
                headers: {
                    "x-api-key": localStorage.getItem("getfit-token")
                }
            })
